...
const allFeatureCards = [
    ...
    },
    {
        ...
        description: "Powered by advanced AI models to improve project descriptions, optimize professional summaries, and suggest impactful achievements with industry-specific insights.",
        bgColor: "bg-orange-500/10",
    },
    {
        icon: <Palette className="w-8 h-8 text-indigo-600" />,
        title: "Smart Template Matching",
        description: "AI analyzes your profession and experience to recommend the perfect template from our collection of 15+ unique, professionally designed layouts.",
                            ...
                            <div className="space-y-8">
                                ...
                                >
                                    {[
                                        ...
                                        { label: 'Certifications', value: '1', icon: Target, color: 'text-indigo-600 bg-indigo-50' },
        ...
        <div className="container mx-auto px-4 py-12">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div className="md:col-span-2">
                    <Link href="/" className="flex items-center gap-2 mb-4">
                        ...
                        <div>
                            <span className="font-bold text-xl text-white">Parichay</span>
                            <p className="text-xs text-slate-400 -mt-1">Powered by Advanced AI</p>
                        </div>
                    </Link>
            ...
            <div className="mt-8 pt-8 border-t border-slate-700 text-center text-sm">
                 <p className="flex items-center justify-center gap-1.5">
                    © {new Date().getFullYear()} Parichay. All rights reserved. Built with <Heart className="w-4 h-4 text-red-500" /> and advanced AI.
                </p>
            </div>
        </div>
      </footer>

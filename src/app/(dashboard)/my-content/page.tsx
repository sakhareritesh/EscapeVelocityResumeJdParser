...
export default function MyContentPage() {
  ...
  const uniqueResources = allResources.filter(
    (item, index, self) =>
      index === self.findIndex((t) => t.resource.url === item.resource.url),
  );
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-sm text-gray-500 mt-1">
          Your analysis history, learning resources, and session data - all in
          one place.
        </p>
      </motion.div>
      ...
      {sessions.length === 0 ? (
        ...
        >
          ...
          <p className="text-sm text-gray-500 text-center max-w-md mb-6">
            Upload your resume to start building your personalized learning
            library with AI-curated resources and session history.
          </p>
        ...
        <Tabs defaultValue="sessions" className="w-full">
          <TabsList className="bg-white border border-gray-200 p-1 rounded-lg">
            <TabsTrigger
              value="sessions"
              className="gap-1.5 text-xs data-[state=active]:bg-[#e8f1fd] data-[state=active]:text-[#0a66c2]"
            >
              ...
              {sessions.map((session, idx) => (
                ...
                >
                  ...
                  {session.resume_skills &&
                    session.resume_skills.length > 0 && (
          ...
          <TabsContent value="resources" className="mt-6">
            {uniqueResources.length > 0 ? (
              ...
              <EmptyState
                icon={<BookOpen />}
                message="No learning resources yet. Run an analysis to get AI-curated resources."
              />
            )}
          </TabsContent>
        </Tabs>

...
const goodies = [
    { name: 'SkillMapr Mug', cost: 500, icon: <ShoppingBag className="w-12 h-12 text-primary" /> },
    { name: 'SkillMapr Hoodie', cost: 1000, icon: <ShoppingBag className="w-12 h-12 text-primary" /> },
